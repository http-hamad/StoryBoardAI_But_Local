...
from . import storyboardai_pb2 as storyboardai__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in storyboardai_pb2_grpc.py depends on'
...
def add_StoryServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('storyboardai.StoryService', rpc_method_handlers)
...
def add_ImageServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('storyboardai.ImageService', rpc_method_handlers)
...
def add_VoiceServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('storyboardai.VoiceService', rpc_method_handlers)
...
def add_VideoServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('storyboardai.VideoService', rpc_method_handlers)
